...
import { registerHostAuth, type HostAuth } from '@openeventkit/widget-core/host-auth';
import { registerHostConfig, type HostConfig } from '@openeventkit/widget-core/host-config';
import { webComponentTag, type WidgetManifest } from '@openeventkit/widget-core';
